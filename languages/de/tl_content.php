...
$GLOBALS['TL_LANG']['tl_content']['h4a_liga_ID']['1'] = 'Bitte geben Sie die 5-stellige ID der Liga ein';

$GLOBALS['TL_LANG']['tl_content']['h4a_team_ID']['0'] = 'Team ID';
$GLOBALS['TL_LANG']['tl_content']['h4a_team_ID']['1'] = 'Bitte geben Sie die 6-stellige ID des Teams auf www.handball4all.de ein';

$GLOBALS['TL_LANG']['tl_content']['my_team_name']['0'] = 'Mein Team';
$GLOBALS['TL_LANG']['tl_content']['my_team_name']['1'] = 'Genaue Bezeichnung der Mannschaft, die per CSS hervorgehoben werden soll';
